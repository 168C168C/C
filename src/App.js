...
//  合约地址
const UNIVERSAL_POINTS_ADDRESS = "0x92867a776E5312bCDf22443Ec25B023BE19CC971";
const POINTS_EXCHANGE_ADDRESS  = "0x49dE18A6D6dEFE30B2dDF4dc91FDe9CED2050Dc7";
...
function App() {
  ...
  {!isWalletConnected ? (
    ...
    <div className="connected-content">
      ...
      {/* 圆形模块容器 */}
      <div className="circular-modules">
        {/* 部署通用积分发行合约 */}
        <div className="circular-module">
          <h2>部署通用积分发行合约</h2>
          <div className="module-content">
            ...
            <input
              ...
              className="round-input"
            />
            <button className="round-button" onClick={handleDeploy}>部署合约</button>
          </div>
        </div>
        ...
        <div className="circular-module">
          ...
          <div className="module-content">
            <input
              ...
              className="round-input"
            />
            <button className="round-button" onClick={handleLoadContract}>导入合约</button>
          </div>
        </div>
        ...
        <div className="circular-module">
          ...
          <div className="module-content">
            <input
              ...
              className="round-input"
            />
            <button className="round-button" onClick={issueRegularPoints}>发行积分</button>
          </div>
        </div>
        ...
        <div className="circular-module">
          ...
          <div className="module-content">
            ...
            <button className="round-button" onClick={getPointsBalance}>更新余额</button>
          </div>
        </div>
        ...
        <div className="circular-module">
          ...
          <div className="module-content">
            ...
            <button className="round-button" onClick={exchangePoints}>兑换</button>
          </div>
        </div>
      </div>
    </div>
