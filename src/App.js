...
//  合约地址
const MYNFT_ADDRESS = "0x142F4868b94e72b5D31fdA0658504eeEe0880274";
const MARKET_ADDRESS = "0x7C3AFe1Da40017Eac71441A405e5fac09EE521cC";
...
function App() {
  ...
  {!account ? (
    <div className="text-box">
      <button onClick={connectWallet} className="round-btn">Connect Wallet</button>
    </div>
  ) : (
    <div>
      ...
      <div className="text-box">
        ...
        <form>
          ...
          />
          <button onClick={mintNFT} disabled={loading} className="round-btn">
      ...
      <div className="text-box">
        ...
        <form>
          ...
          />
          <button onClick={listNFTForSale} disabled={loading} className="round-btn">
          ...
          <ul>
            {nftsForSale.map(({ tokenId, price }) => (
              <li key={tokenId.toString()}>
                ...
                <button onClick={() => buyNFT(tokenId, price)} disabled={loading} className="round-btn">
